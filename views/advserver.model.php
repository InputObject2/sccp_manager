            ...
            <div class="modal-body">
                <div class="element-container"><div class="row"> <div class="form-group"><div class="col-md-3">
                    ...
                    <div class="row"><div class="col-md-12">
                        <span id="new_model-help" class="help-block fpbx-help-block"><?php echo _("Device model identifier (e.g. 79XX, 7965)."); ?></span>
                </div></div></div>
                ...
                <div class="element-container"><div class="row"> <div class="form-group"><div class="col-md-3">
                    ...
                    <div class="row"><div class="col-md-12">
                        <span id="new_dns-help" class="help-block fpbx-help-block"><?php echo _("Phone without sidecars, with one/two sidecars, or sidecar only."); ?></span>
                </div></div></div>
                ...
                <div class="element-container"><div class="row"> <div class="form-group"><div class="col-md-3">
                    ...
                    <div class="row"><div class="col-md-12">
                        <span id="new_buttons-help" class="help-block fpbx-help-block"><?php echo _("Number of line buttons on the phone."); ?></span>
                </div></div></div>
                ...
                <div class="element-container"><div class="row"> <div class="form-group"><div class="col-md-3">
                    ...
                    <div class="row"><div class="col-md-12">
                        <span id="new_loadimage-help" class="help-block fpbx-help-block"><?php echo _("Firmware load image filename."); ?></span>
                </div></div></div>
                ...
                <div class="element-container"><div class="row"> <div class="form-group"><div class="col-md-3">
                    ...
                    <div class="row"><div class="col-md-12">
                        <span id="new_loadinformationid-help" class="help-block fpbx-help-block"><?php echo _("Load information ID for firmware (Cisco format)."); ?></span>
                </div></div></div>
                ...
                <div class="element-container"><div class="row"> <div class="form-group"><div class="col-md-3">
                    ...
                    <div class="row"><div class="col-md-12">
                        <span id="new_nametemplate-help" class="help-block fpbx-help-block"><?php echo _("XML template name for this model."); ?></span>
                </div></div></div>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="element-container"><div class="row"> <div class="form-group"><div class="col-md-3">
                    ...
                    <div class="row"><div class="col-md-12">
                        <span id="editd_model-help" class="help-block fpbx-help-block"><?php echo _("Device model identifier (e.g. 79XX, 7965)."); ?></span>
                </div></div></div>
                ...
                <div class="element-container"><div class="row"> <div class="form-group"><div class="col-md-3">
                    ...
                    <div class="row"><div class="col-md-12">
                        <span id="editd_dns-help" class="help-block fpbx-help-block"><?php echo _("Phone without sidecars, with one/two sidecars, or sidecar only."); ?></span>
                </div></div></div>
                ...
                <div class="element-container"><div class="row"> <div class="form-group"><div class="col-md-3">
                    ...
                    <div class="row"><div class="col-md-12">
                        <span id="editd_buttons-help" class="help-block fpbx-help-block"><?php echo _("Number of line buttons on the phone."); ?></span>
                </div></div></div>
                ...
                <div class="element-container"><div class="row"> <div class="form-group"><div class="col-md-3">
                    ...
                    <div class="row"><div class="col-md-12">
                        <span id="editd_loadinformationid-help" class="help-block fpbx-help-block"><?php echo _("Load information ID for firmware (Cisco format)."); ?></span>
                </div></div></div>
                ...
                <div class="element-container"><div class="row"> <div class="form-group"><div class="col-md-3">
                    ...
                    <div class="row"><div class="col-md-12">
                        <span id="editd_nametemplate-help" class="help-block fpbx-help-block"><?php echo _("XML template name for this model."); ?></span>
                </div></div></div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo _('Close');?></button>
